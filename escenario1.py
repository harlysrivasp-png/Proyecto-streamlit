...
def escenario1():
    ...
    st.markdown("""
    En este escenario se ingresan manualmente los datos de un estudiante.
    El modelo entrenado predice si el estudiante presenta riesgo de abandono académico.
    """)
    ...
    try:
        ...
        st.error("No se encontró el archivo modelo_entrenado.pkl.")
        st.stop()
